...
# ========================================
# LLM & embedding usage (OpenRouter is external; SageMaker in AWS)
# ========================================
    ...
    widgets = [
      {
        ...
        height = 3
        properties = {
          markdown = "## LLM traffic\n\nAlex routes all chat/completions through **OpenRouter** ([openrouter.ai](https://openrouter.ai)). Usage, limits, and spend are visible in the OpenRouter dashboard, not in AWS Bedrock metrics."
        }
      },
