...
1. WEB RESEARCH (1-2 pages MAX):
   - Navigate to ONE main source (try Yahoo Finance, MarketWatch, or Google News)
   - Many sites block automated/datacenter browsers; if navigation fails or the page is empty/blocked, try another source (e.g. Reuters.com, SEC.gov EDGAR, or a major index overview page)
   - Use browser_snapshot to read visible content after load settles
